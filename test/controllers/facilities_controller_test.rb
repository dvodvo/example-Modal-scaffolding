...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference("Facility.count") do
      post facilities_url, params: { facility: { capacity: @facility.capacity, description: @facility.description, name: @facility.name } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { capacity: @facility.capacity, description: @facility.description, name: @facility.name } }
